...
INSERT INTO "new_ArtworkAnalysis" ("ai_tags", "analysis_date", "artwork_id", "child_id", "id", "image_url", "main_subjects", "predominant_colors", "technique_notes") SELECT "ai_tags", "analysis_date", "artwork_id", "child_id", "id", "image_url", "main_subjects", "predominant_colors", "technique_notes" FROM "ArtworkAnalysis";
